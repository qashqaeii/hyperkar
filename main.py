...
option = st.selectbox(
    ...
    ('سیستم تعلیق، ترمز و ایمنی', 'سیستم انتقال قدرت', 'سیستم الکتریکی خودرو'))
#,'سیستم های رفاهی و ایمنی','موتور' ,
#     'شاسی وبدنه خودرو', 'مایعات و روان کاوها')) 'مکمل ها ، اسپری ها و تمیزکننده ها', 'سیستم صوتی و تصویری',     'قطعات آپشن',
